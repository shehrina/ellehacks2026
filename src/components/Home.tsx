  ...
  return (
    <div className="p-6 pb-24 max-w-2xl mx-auto flex flex-col items-center">
      ...
      <div className="w-full mb-10 px-4 flex flex-row items-center justify-center gap-4">
        ...
        <button
          onClick={() => navigate('/ar')}
          className="flex-1 max-w-[180px] bg-[#C3B1E1] hover:bg-[#b2a0d0] border-b-[6px] border-[#a18fbf] rounded-xl py-3 px-4 flex items-center justify-center gap-2 shadow-lg transition-all duration-300 hover:scale-[1.03] hover:-translate-y-1 active:translate-y-1 active:border-b-[2px] group"
        >
          {/* Box Icon Container */}
